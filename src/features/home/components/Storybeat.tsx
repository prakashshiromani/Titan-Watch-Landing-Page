...
export default function Storybeat({ children, range, position = "center" }: StorybeatProps) {
    ...
    const leftTransform = useTransform(scrollYProgress, range, [-14, 0, 0, 10]);
    const rightTransform = useTransform(scrollYProgress, range, [14, 0, 0, -10]);
    const centerTransform = useTransform(scrollYProgress, range, [0, 0, 0, 0]);
