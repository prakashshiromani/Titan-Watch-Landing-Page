...
import { VARIANTS, SPECS, FEATURES, DETAILS } from "@/constants/watchData";

export default function SpecsFeature() {
    ...
    return (
        <main className="min-h-screen bg-[#050505] text-white">
            ...
            <div className="fixed top-4 left-4 sm:top-5 sm:left-6 z-50">
                <Link
                    href="/"
                    className="flex items-center gap-2 text-white/55 hover:text-white transition-colors text-xs uppercase tracking-widest group"
                >
            ...
            <section className="relative flex flex-col lg:flex-row overflow-hidden pt-12 sm:pt-0">
                ...
                <div className="relative lg:w-1/2 flex items-center justify-center min-h-[50vw] sm:min-h-[60vh] lg:min-h-screen bg-[#080806] overflow-hidden">
                    ...
                    <div
                        ...
                        style={{
                            background: VARIANTS[activeVariant].glow,
                            opacity: 0.13,
                            top: "50%",
                            left: "50%",
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-center gap-4 mb-8 sm:mb-12">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    className="flex items-center gap-2 py-3.5 px-7 rounded-full font-bold uppercase tracking-[0.15em] text-xs text-white/70 hover:text-white transition-all duration-300 hover:-translate-y-0.5 cursor-pointer"
                                    style={{
            ...
            >
                <div className="max-w-6xl mx-auto px-6">
                    <div
                        className="grid grid-cols-3 md:grid-cols-6 gap-8 md:gap-0 divide-y md:divide-y-0 md:divide-x"
            ...
            <section className="max-w-6xl mx-auto px-6 py-28">
                <div className="text-center mb-16">
                    <p
                        className="text-[10px] uppercase tracking-[0.5em] mb-4 flex items-center justify-center gap-3"
                ...
                <div className="max-w-4xl mx-auto px-6">
                    <div className="text-center mb-14">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-white">
                            Model <span style={{ color: accent }}>{VARIANTS[activeVariant].code}</span>
                        </h2>
                    </div>
                    ...
                    <div className="rounded-2xl overflow-hidden" style={{ border: `1px solid ${accent}18` }}>
                        {DETAILS.map((d, i) => {
                            let val = d.value;
                            if (d.label === "Reference") val = VARIANTS[activeVariant].code;
                            if (d.label === "Colour Variant") val = VARIANTS[activeVariant].label;
            ...
            >
                ...
                />
                <p
                    className="text-[10px] uppercase tracking-[0.5em] mb-6 flex items-center gap-4"
